...
class MainWindow : public QMainWindow
{
    ...
    private:
        ...
        std::vector<std::function<void(MainWindow*, const std::shared_ptr<BabelNetwork::UserResponse> &)>> user_ptr = {&MainWindow::LoggedIn, &MainWindow::LoggedOut, &MainWindow::AccountCreate, &MainWindow::AccountDelete, &MainWindow::WrongLogin, &MainWindow::WrongPassword, &MainWindow::LoginAlreadyTaken, &MainWindow::AlreadyLoggedIn};
        std::vector<std::function<void(MainWindow*, const std::shared_ptr<BabelNetwork::CallResponse> &)>> call_ptr = {&MainWindow::CallStarted, &MainWindow::CallLeft, &MainWindow::IncomingCall, &MainWindow::CallAccepted, &MainWindow::CallRefused, &MainWindow::IncomingCall};
