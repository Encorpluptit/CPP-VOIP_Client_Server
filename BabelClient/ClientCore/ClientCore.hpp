...
//    public:
    ...
    private:
        std::vector<std::function<void(ClientCore *, std::shared_ptr<BabelNetwork::AResponse>)>> dispatch_ptr = {
            &BabelClient::ClientCore::doUnknowTypeResponse, &BabelClient::ClientCore::doUserResponse,
            &BabelClient::ClientCore::doCallResponse, &BabelClient::ClientCore::doFriendResponse,
            &BabelClient::ClientCore::doMessageResponse};
        std::vector<std::function<void(ClientCore *, std::shared_ptr<BabelNetwork::UserResponse>)>> user_ptr = {
            &BabelClient::ClientCore::LoggedIn, &BabelClient::ClientCore::LoggedOut,
            &BabelClient::ClientCore::AccountCreate, &BabelClient::ClientCore::AccountDelete,
            &BabelClient::ClientCore::WrongLogin, &BabelClient::ClientCore::WrongPassword,
            &BabelClient::ClientCore::LoginAlreadyTaken, &BabelClient::ClientCore::AlreadyLoggedIn};
        std::vector<std::function<void(ClientCore *, std::shared_ptr<BabelNetwork::CallResponse>)>> call_ptr = {
            &BabelClient::ClientCore::CallStarted, &BabelClient::ClientCore::CallLeft,
            &BabelClient::ClientCore::IncomingCall, &BabelClient::ClientCore::CallAccepted,
            &BabelClient::ClientCore::CallRefused, &BabelClient::ClientCore::IncomingCall};
        std::vector<std::function<void(ClientCore *, std::shared_ptr<BabelNetwork::FriendResponse>)>> friend_ptr = {
            &BabelClient::ClientCore::AddFriend, &BabelClient::ClientCore::FriendRequest,
            &BabelClient::ClientCore::UnknowUser};
        std::vector<std::function<void(ClientCore *, std::shared_ptr<BabelNetwork::MessageResponse>)>> message_ptr = {
            &BabelClient::ClientCore::SendMessageOk, &BabelClient::ClientCore::ReceiveMessage,
            &BabelClient::ClientCore::UnknowUserMessage};
        bool logged;
        std::string name;
